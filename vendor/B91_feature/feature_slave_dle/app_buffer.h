...
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_52_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			52
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_56_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			56
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_100_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			100
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_200_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			200
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_251_BYTES)
...
#if (DLE_LENGTH_SELECT == DLE_LENGTH_251_BYTES) //TX FIFO size is 272 when MAX_TX_Octet is 251, 272*16 > 4096, so can not use 17
